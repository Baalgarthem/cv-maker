...
export const sampleResume: ResumeDocument = {
  ...
  sections: [
    { id: "summary", label: "Perfil profesional", isVisible: true },
    { id: "experience", label: "Experiencia profesional", isVisible: true },
    { id: "education", label: "Formación académica", isVisible: true },
    { id: "skills", label: "Habilidades y competencias", isVisible: true },
    { id: "languages", label: "Idiomas", isVisible: true, inSidebar: true },
    { id: "courses", label: "Cursos y formación", isVisible: true, inSidebar: true },
    { id: "portfolio", label: "Portafolio", isVisible: true, inSidebar: true },
  ],
  templateId: "oxford",
